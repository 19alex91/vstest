========================================================================
    KONSOLENANWENDUNG: Projektarbeit1-Projektübersicht
========================================================================

Diese Projektarbeit1-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Projektarbeit1-Anwendung besteht.


Projektarbeit1.vcxproj
...
Projektarbeit1.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Projektarbeit1.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
